...
class Unet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        #"model_path"    : 'logs/ep100-loss0.014-val_loss0.022.pth',
        #原始unet 100代权重
        #"model_path"    : 'logs/ep010-loss0.018-val_loss0.026.pth',
        #卷积100
        #"model_path"    : 'logs/ep100-loss0.013-val_loss0.039.pth',
